package com.lingman.lib.common.view;
...
/**
 * Created by Norton on 2018/4/8.
 */

@SuppressLint("RestrictedApi")
public class DefaultHead extends InternalClassics<DefaultHead> implements RefreshHeader {
    ...
    public static String REFRESH_HEADER_UPDATE = "上次更新 MM-dd HH:mm";//"上次更新 M-d HH:mm";
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public DefaultHead(Context context) {
        this(context, null);
    }

    public DefaultHead(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DefaultHead(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        tvHead.setTextColor(0xff7c7c7c);
//        tvHead.setTextSize(10);
//        tvHead.setText(R.string.app_name);
//        tvHead.setId(R.id.tv_head);
//        this.addView(tvHead);

//        LayoutParams lp = (LayoutParams) tvHead.getLayoutParams();
//        lp.addRule(RelativeLayout.CENTER_HORIZONTAL, RelativeLayout.TRUE);
//        tvHead.setLayoutParams(lp);

//        LayoutParams lp1 = (LayoutParams) mCenterLayout.getLayoutParams();
//        lp1.addRule(RelativeLayout.BELOW, tvHead.getId());
//        lp1.setMargins(0, DensityUtil.dp2px(16),0,0);
//        mCenterLayout.setLayoutParams(lp1);
...
//    }
    ...
    public void onStateChanged(@NonNull RefreshLayout refreshLayout, @NonNull RefreshState oldState, @NonNull RefreshState newState) {
        ...
        switch (newState) {
            case None:
                updateView.setVisibility(mEnableLastTime ? VISIBLE : INVISIBLE);
    ...
    public DefaultHead setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public DefaultHead setTimeFormat(DateFormat format) {
    ...
    public DefaultHead setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

    public DefaultHead setAccentColor(@ColorInt int accentColor) {
        mLastUpdateText.setTextColor(accentColor&0x00ffffff|0xcc000000);
        return super.setAccentColor(accentColor);
    }

    public DefaultHead setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
...
//            mRefreshKernel.requestRemeasureHeightForHeader();
    ...
    public DefaultHead setTextSizeTime(float size) {
...
//    }
    ...
    public DefaultHead setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
